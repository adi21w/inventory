...
<div class="card">
    <div class="card-body">
        <?php Pjax::begin(['id' => 'tableGrid0', 'timeout' => 5000, 'enablePushState' => false, 'options' => ['data-model' => 'packs', 'data-home' => '/packs']]); ?>
        <?= GridView::widget([
            ...
            'toolbar' =>  [
                ...
                [
                    'content' => Html::a('<i class="fas fa-redo-alt"></i>', ['/packs'], ['class' => 'btn btn-warning', 'title' => Yii::t('kvgrid', 'Reset Grid')])
                ],
                '{export}',
                '{toggleData}',
            ],
