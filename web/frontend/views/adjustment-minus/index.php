...
$this->title = 'Adjustment Minus';
$this->params['breadcrumbs'][] = $this->title;
$this->registerJsFile("@web/js/apps/component/base.js?v" . date('Ymd'), ['depends' => [\yii\web\YiiAsset::class]]);
?>
<div class="card mb-4">
    <div class="card-body">
        <?php Pjax::begin(['id' => 'tableGrid0', 'timeout' => 5000, 'enablePushState' => false, 'options' => ['data-model' => 'tadjustmenthd', 'data-home' => '/adjustment-minus']]); ?>
        <?= GridView::widget([
