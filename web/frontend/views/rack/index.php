...
$this->title = 'Master Packs';
$this->params['breadcrumbs'][] = $this->title;
$this->registerJsFile("@web/js/apps/component/base.js?v" . date('Ymd'), ['depends' => [\yii\web\YiiAsset::class]]);
?>
<div class="card">
    <div class="card-body">
        <?php Pjax::begin(['id' => 'tableGrid0', 'timeout' => 5000, 'enablePushState' => false, 'options' => ['data-model' => 'rack', 'data-home' => '/rack']]); ?>
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'template' => '<div class="action-wrapper">' . Helper::filterActionColumn('{update} {view} {delete}') . '</div>',
                    'buttons' => [
            ...
            'toolbar' =>  [
                [
                    'content' => (Helper::checkRoute('/rack/create')) ? Html::button('<i class="fas fa-plus"></i>', ['class' => 'btn btn-blue', 'title' => Yii::t('kvgrid', 'Add Data'), 'id' => 'btn-add-grid']) : null
                ],
                [
                    'content' => Html::a('<i class="fas fa-redo-alt"></i>', ['/rack'], ['class' => 'btn btn-warning', 'title' => Yii::t('kvgrid', 'Reset Grid')])
                ],
                '{export}',
                '{toggleData}',
            ],
